/**
 * Teclado, mouse e stick virtual. O voo lê `axis` (x, y, z) a cada frame.
 */
...
export class Input {
    ...
    bindTouch({ stick, knob, up, down, lantern }) {
        if (!stick) return;
        const setKnob = (x, y) => {
