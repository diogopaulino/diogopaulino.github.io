...
import { InputManager } from './InputManager.js?v=33';
...
import { CombatSystem } from '../game/CombatSystem.js?v=33';
import { CheckpointManager } from '../game/CheckpointManager.js';
import { StoryDirector } from '../game/StoryDirector.js';
import { SceneManager, CHECKPOINT_STAGE } from './SceneManager.js?v=33';
import { ThirdPersonCamera } from '../player/ThirdPersonCamera.js?v=33';
import { Player } from '../player/Player.js?v=33';
import { Teco } from '../characters/Teco.js?v=6';
import { Camila } from '../characters/Camila.js?v=6';
