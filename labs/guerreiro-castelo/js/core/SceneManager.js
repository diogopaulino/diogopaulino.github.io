import { HomeLevel } from '../levels/HomeLevel.js?v=4';
import { ShipLevel } from '../levels/ShipLevel.js?v=4';
import { BeachLevel } from '../levels/BeachLevel.js?v=3';
import { ForestLevel } from '../levels/ForestLevel.js?v=3';
import { CastleExteriorLevel } from '../levels/CastleExteriorLevel.js?v=4';
...
import { EscapeLevel } from '../levels/EscapeLevel.js?v=4';
import { ShipEscapeLevel } from '../levels/ShipEscapeLevel.js?v=4';
import { EndingLevel } from '../levels/EndingLevel.js?v=4';
