...
import { createSky, createClouds, createRoad, America } from './world.js?v=4';
import { Player } from './player.js?v=4';
import { Track } from './obstacles.js?v=4';
import { Pack } from './followers.js?v=4';
import { Effects } from './effects.js';
import { GameAudio } from './audio.js';
import { Input } from './input.js';
import { Hud } from './hud.js';
import { createFeatherMesh } from './models.js?v=4';
const CAMERAS = [
