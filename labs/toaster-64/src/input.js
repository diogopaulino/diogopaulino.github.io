/**
 * Teclado, mouse, toque (joystick virtual) e atalhos de HUD.
 * O jogo só lê eixos e consumeJump / consumeFire.
 */
...
export class Input {
    ...
    _bind() {
        this._onKeyDown = (e) => {
            ...
            if (e.code === 'KeyF' || e.code === 'ControlLeft' || e.code === 'KeyJ') {
                e.preventDefault();
        ...
        this._onPointerDown = (e) => {
            ...
            if (t?.closest?.('#firePad') || t?.id === 'scene') {
